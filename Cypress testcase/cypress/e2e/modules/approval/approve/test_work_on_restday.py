...
class Setup():
    def setup_method(self):
        ...
        restday_approval = self.driver.find_element(By.XPATH, '//*[@id="undertime_overtime_approval"]/a')
        approval.click()
        restday_approval.click()

        restday_section = self.driver.find_element(By.XPATH, "//*[@ui-sref='workonrestday_approval']")
        restday_section.click()
        sleep(7)
...
class TestDropDown(Setup):
    ...
    def test_print_function(self):
        ...
        expected_text = "Work on rest day Approval"
...
class TestRecordsField(Setup):
    ...
    @pytest.mark.skip(reason="passed")
    def test_records_restday_approval_request_approve_recommended_record(self):
    ...
    @pytest.mark.skip(reason="passed")
    def test_records_restday_approval_request_recommended_record_edit_date(self):
        """ Check response when clicking "Overtime Approval Request" dialog """

        expected_text = "Request successfully approved."
        expected_data = "05/23/2022"
        expected_status = "Recommended"
        record_row_xpath = "//*[@id='table']/tbody/tr[1]/td[4]"
    ...
    @pytest.mark.skip(reason="passed")
    def test_records_restday_approval_request_recommended_record_edit_hours(self):
    ...
    @pytest.mark.skip(reason="passed")
    def test_records_restday_approval_request_not_recommended_record(self):
