...
from utils import searchbox, filter_effectivity, right_click, pagination, prompt, auto_approval_review, record_per_page, record_field
...
from utils.apply import reviewer_apply as apply
...
class TestAutoApproval(Setup):
    ...
    def test_auto_approval_review_dropdown_functionality(self):
        ...
        review_option = self.driver.find_element(By.XPATH, "/html/body/div[2]/div/div[3]/div/div/div/div[1]/form/div[6]/div/div/ul/li/ul/li/div/div")
        review_option.click()
        sleep(3)
...
class TestRecordsField(Setup):
    ...
    def test_response_when_clicking_record_checkbox(self):
        ...
        sleep(3)
        deselect_all = self.driver.find_element(By.XPATH, "//*[@id='page-wrapper']/div[3]/div/div/div/div[1]/form/div[2]/"
    ...
    def test_response_when_clicking_not_endorse(self):
        """ Check response when clicking "Leave not endorse" button """

        expected_text = "Request successfully not endorsed."
        record_row_xpath = '//*[@id="table"]/tbody/tr[1]'
        ...
        input_pending.send_keys(Keys.ENTER)
        sleep(2)
        apply_search = self.driver.find_element(By.XPATH, "//*[@id='page-wrapper']/div[3]/div/div/div/div[1]/form/div[2]/""tabletoolstrans/div/div/div/div/div[2]/div/div/div/span[1]/div[11]/button[1]")
        apply_search.click()
        sleep(5)

        dialog_displayed = record_field.record_row(self, record_row_xpath)
        approve_selected = record_field.not_endorse(self)
        submit_button = self.driver.find_element(By.XPATH, "//*[@aria-label='Submit']")
        submit_button.click()
        sleep(3)
        confirmation_displayed = record_field.confirm_button(self)
    ...
    def test_response_when_clicking_review(self):
        """ Check response when clicking "Leave review" button """
