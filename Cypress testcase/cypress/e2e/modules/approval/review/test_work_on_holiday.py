...
class Setup():
    ...
    def setup_method(self, method):
        ...
        work_on_holiday_approval = self.driver.find_element(By.XPATH, '/html/body/div[2]/div/div[3]/div/div/div/div/nav/ul/li[3]/a')
        work_on_holiday_approval.click()
        sleep(10)
...
class TestRecordsField(Setup):
    ...
    def test_response_when_clicking_overtime_approval_dialog_reviewed(self):
        ...
        expected_text = "Request successfully reviewed."
        record_row_xpath = '//*[@id="table"]/tbody/tr[5]'
        edit_date = "01/01/2022"
