...
class Setup():
    ...
    def setup_method(self): 
        ...
        self.driver.get("https://yp.yahshuasupport.com/employees/additional_pay_and_deductions/regular_deduction/main_page/")
        
    def teardown_method(self, method):
        self.driver.quit()

class TestRegularDeduction(Setup):
    """Request leave test cases.""" 

    def test_clicking_viewby_button(self):
        """ Click "View By" dropdown button  on the upper left side of the page under "Regular Deduction" . """

        view_by_dropdown = self.driver.find_element_by_xpath("//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[2]/div/a/span[3]/b")
        view_by_dropdown.click()

        view_by_dropdown_options = self.driver.find_element_by_xpath("//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[2]/div/div").is_displayed()
        
        assert  view_by_dropdown_options == True

    def test_clicking_viewby_summary_option(self, capsys):
        """ Check response on clicking "Summary" options under "View By" dropdown button in the "Regular Deductions" . """
        ...
        summary_table_record = self.driver.find_element(By.XPATH, "//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[10]/div/table[1]")
    ...
    def test_clicking_viewby_detailed_option(self):
        """ Check response on clicking "Detailed" options under "View By" dropdown button in the "Regular Deductions" ."""
    ...
    def test_clicking_input_box(self):
        """Check response on clicking input box under "Regular Deduction Type".""" 

        regular_deduction_type_input = self.driver.find_element_by_xpath("//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[6]/div/ul/li/input")
        regular_deduction_type_input.click()

        regular_deduction_type_input_selection = self.driver.find_element_by_xpath("//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[6]/div/div").is_displayed()
        
        assert  regular_deduction_type_input_selection == True

    def test_clicking_select_all_button(self):
        """Check response on clicking "Select All" button under "Regular Deduction Type"""

        sleep(5)
        select_all_button = self.driver.find_element(By.XPATH, "//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[6]/button[1]")
        select_all_button.click()
       
        regular_deduction_type_options = self.driver.find_element(By.XPATH, "//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[6]/div/ul/li/input")
        regular_deduction_type_options.get_attribute('value')

        assert regular_deduction_type_options != "All"

    def test_clicking_deselect_all_button(self):
        """Check response on clicking "Deselect All" button under "Regular Deduction Type"""

        select_all_button = self.driver.find_element(By.XPATH, "//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[6]/button[1]")
        select_all_button.click()

        sleep(3)
        deselect_all_button = self.driver.find_element(By.XPATH, "//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[6]/button[2]")
        deselect_all_button.click()

        regular_deduction_type_options = self.driver.find_element(By.XPATH, "//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[6]/div/ul/li/input")
        return_default_value = regular_deduction_type_options.get_attribute("placeholder")
    ...
    def test_clicking_multiple_regular_deduction_type(self):
        ...
        multiple_locaton_selection = ["COOP","HDMF Loan"]
...
class TestSearchRegularDeduction(Setup):
    ...
    def test_searching_employee_name(self, capsys):
        ...
        employee_name_list = []
        for page in range(page_count):
            table_row_count_request =  self.driver.find_elements_by_xpath("//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[10]/div/table[1]/tbody/tr[1]/th[2]")
...
class TestAdvanceFilter(Setup):
    ...
    def test_clicking_advance_filter(self):
        ...
        advance_filter_popup = self.driver.find_element_by_xpath("//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[4]/tabletoolstrans/div/div/div/div")
    ...
    def test_advance_filter_payroll_status_dropdown_button(self):
        ...
        x_icon = self.driver.find_element_by_xpath("//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[4]/tabletoolstrans/div/div/div/div/div[2]/div/div/div/span[1]/div[1]/div/a/abbr")
        x_icon.click()

        payroll_status_option = self.driver.find_element_by_xpath("//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[4]/tabletoolstrans/div/div/div/div/div[2]/div/div/div/span[1]/div[1]/div/a/span[1]").text
    ...
    def test_advance_filter_inputting_location(self):
        ...
        x_icon = self.driver.find_element_by_xpath("//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[4]/tabletoolstrans/div/div/div/div/div[2]/div/div/div/span[1]/div[2]/div/ul/span/li/a")
        ...
        select_all_button =  self.driver.find_element_by_xpath("//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[4]/tabletoolstrans/div/div/div/div/div[2]/div/div/div/span[1]/div[2]/button[1]")
        select_all_button.click()
        sleep(10)
        deselect_all_button = self.driver.find_element_by_xpath("//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[4]/tabletoolstrans/div/div/div/div/div[2]/div/div/div/span[1]/div[2]/button[2]")
        deselect_all_button.click()

        location_inputbox = self.driver.find_element_by_xpath("//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[4]/tabletoolstrans/div/div/div/div/div[2]/div/div/div/span[1]/div[2]/div/ul/li/input")
    ...
    def test_advance_filter_inputting_division(self):
        ...
        x_icon = self.driver.find_element_by_xpath("//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[4]/tabletoolstrans/div/div/div/div/div[2]/div/div/div/span[1]/div[3]/div/ul/span/li/a")
        x_icon_displayed = x_icon.is_displayed()
        ...
        division_inputbox = self.driver.find_element_by_xpath("//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[4]/tabletoolstrans/div/div/div/div/div[2]/div/div/div/span[1]/div[2]/div/ul/li/input")
    ...
    def test_advance_filter_inputting_department(self):
        ...
        x_icon = self.driver.find_element_by_xpath("//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[4]/tabletoolstrans/div/div/div/div/div[2]/div/div/div/span[1]/div[4]/div/ul/span/li/a")
        x_icon_displayed = x_icon.is_displayed()
        ...
        select_all_button = self.driver.find_element_by_xpath("//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[4]/tabletoolstrans/div/div/div/div/div[2]/div/div/div/span[1]/div[3]/button[1]")
        select_all_button.click()

        deselect_all_button = self.driver.find_element_by_xpath("//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[4]/tabletoolstrans/div/div/div/div/div[2]/div/div/div/span[1]/div[4]/button[2]")
        deselect_all_button.click()

        department_inputbox = self.driver.find_element_by_xpath("//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[4]/tabletoolstrans/div/div/div/div/div[2]/div/div/div/span[1]/div[2]/div/ul/li/input")
    ...
    def test_advance_filter_inputting_section(self):
        ...
        select_all_button = self.driver.find_element_by_xpath("//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[4]/tabletoolstrans/div/div/div/div/div[2]/div/div/div/span[1]/div[4]/button[1]")
        select_all_button.click()
    ...
    def test_advance_filter_inputting_job_level(self):
        ...
        x_icon = self.driver.find_element_by_xpath("//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[4]/tabletoolstrans/div/div/div/div/div[2]/div/div/div/span[1]/div[6]/div/a/abbr")
        x_icon.click()
    ...
    def test_advance_filter_inputting_employee(self):
        ...
        x_icon = self.driver.find_element_by_xpath("//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[4]/tabletoolstrans/div/div/div/div/div[2]/div/div/div/span[1]/div[7]/div/div[2]/a/abbr")
        x_icon.click()
    ...
    def test_advance_filter_inputting_search(self):
        ...
        #Click "Table Record" details.

        # assert displays records according to filtered options
...
class TestCaretButton(Setup):
    ...
    def test_regular_dedecution_caret_dropdown_export_button(self, capsys): 
        ...
        export_option = self.driver.find_element(By.XPATH, "//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[4]/tabletoolstrans/div/div/div/ul/li[1]/a")
        export_option.click()
        sleep(1)
    ...
    def test_regular_dedecution_caret_dropdown_import_regular_button(self): 
        ...
        import_regular = self.driver.find_element(By.XPATH, "//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[4]/tabletoolstrans/div/div/div/ul/li[2]/a[1]")
        import_regular.click()

        get_url = requests.get("https://yp.yahshuasupport.com/settings/imports/#import_employee_deduction_scheduled")

        assert 200 == get_url.status_code

    def test_regular_dedecution_caret_dropdown_import_scheduled_button(self): 
        """Click "Import Scheduled" dropdown option.""" 
        ...
        import_scheduled = self.driver.find_element(By.XPATH, "//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[4]/tabletoolstrans/div/div/div/ul/li[2]/a[2]")
        import_scheduled.click()

        # import_employee_deduction_page = self.driver.find_element(By.CLASS_NAME, "modal-dialog ")
        # is_import_employee_deduction_page_displayes = import_employee_deduction_page.is_displayed()
        
        # assert is_import_employee_deduction_page_displayes == True
    ...
    def test_regular_dedecution_caret_dropdown_print_button(self): 
        ...
        print_option = self.driver.find_element(By.XPATH, "//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[4]/tabletoolstrans/div/div/div/ul/li[4]/a")
        
        print_option.click()

        get_url = requests.get("https://yp.yahshuasupport.com/employees/additional_pay_and_deductions/deductions/prints/?filters=%7B%22records_per_page%22:10,%22view_by%22:%22Summary%22,%22typee%22:%22Deduction%22,%22type_ids%22:[],%22pagination%22:%7B%22limit%22:10,%22current_page%22:1,%22total_records%22:157,%22total_pages%22:16,%22limit_options_orig%22:[20,50,100,150],%22limit_options%22:[20,50,100,150,157]%7D,%22show_hide_column%22:true,%22show_inactive%22:false,%22is_show_forecast_deduction%22:false%7D&columns=&deduction_view_by=Summary&print=yes&name=&inactive=false")
...
class TestRegularDeductionRecord(Setup):
    def test_regular_dedecution_table_record(self):
    ...
    def test_regular_dedecution_clicking_add_earnings_type_button_under_table_record(self, capsys):
        ...
        add_earnings_type_button = self.driver.find_element(By.XPATH , "//*[@id='page-wrapper']/div[3]/div/div/div/div/div/div/div[2]/div[1]/a")
        is_add_earnings_type_displays = add_earnings_type_button.is_displayed()
        add_earnings_type_button.click()
        ...
        expected_payment_list_url = "https://yp.yahshuasupport.com/settings/payments/miscellaneous/#additional_pay"
        actual_payment_list_url = self.driver.current_url
        
        assert expected_payment_list_url == actual_payment_list_url

    def test_regular_dedecution_create_button_under_table_record(self):
        """Check "Create" button functionality under "Record Table".""" 

        input_deduction_type = "SSS Loan"
        ...
        regular_deduction_type = self.driver.find_element(By.XPATH, "//*[@id='page-top']/div[1]/div/div/div/div[2]/div/div[2]/table/tbody/tr/td/div[1]/div[1]/div")
        regular_deduction_type.click()
        ...
        total_amount = self.driver.find_element(By.XPATH, "//*[@id='input_list_amount']")
        total_amount.send_keys("500")

        sleep(3)

        date_input = self.driver.find_element(By.XPATH , "//*[@id='page-top']/div[1]/div/div/div/div[2]/div/div[2]/table/tbody/tr/td/div[1]/div[3]/p/input")
        date_input.send_keys("05/30/2022")
        check_date_input = date_input.get_attribute('value')
        assert check_date_input == "05/30/2022"

        input_remarks = self.driver.find_element(By.XPATH , "//*[@id='input_list_amount_to_']")
        input_remarks.send_keys("Automated Testing Creating Regular Deduction")

        regular_radio_button = self.driver.find_element(By.XPATH , "//*[@id='regular']")
        regular_radio_button.click()

        payroll_schedule_selection = self.driver.find_element(By.XPATH ,"//*[@id='quincena']")
        payroll_schedule_selection.click()

        sleep(3)

        input_amount_per_deduction = self.driver.find_element(By.XPATH, "//*[@id='page-top']/div[1]/div/div/div/div[2]/div/div[2]/table/tbody/tr/td/div[2]/div[3]/input")
        input_amount_per_deduction.send_keys("100")

        start_date = self.driver.find_element(By.XPATH, "//*[@id='page-top']/div[1]/div/div/div/div[2]/div/div[2]/table/tbody/tr/td/div[3]/div[1]/p/input")
        start_date.send_keys("08/04/2022")

        save_button = self.driver.find_element(By.XPATH, "//*[@id='page-top']/div[1]/div/div/div/div[2]/div/div[2]/table/tbody/tr/td/div[5]/button")
        save_button.click()\

        sleep(0.5)

        expected_text = 'Employee Deduction successfully added.'
        success_message = self.driver.find_element_by_xpath("//*[@aria-label = 'Employee Deduction successfully added.']")
        actual_text = success_message.text

        assert expected_text == actual_text , "Check if the record is already created."

    def test_regular_dedecution_edit_button_under_table_record(self):
        ...
        total_amount = self.driver.find_element(By.XPATH , "/html/body/div[1]/div/div/div/div[2]/div/div[2]/table/tbody/tr[2]/td/div[1]/div[2]/input")
        total_amount.click()
        total_amount.clear()
        total_amount.send_keys("5000")

        save_button = self.driver.find_element(By.XPATH , "/html/body/div[1]/div/div/div/div[2]/div/div[2]/table/tbody/tr[2]/td/div[8]/button[2]")
        save_button.click()

        sleep(0.5)

        expected_text = 'Employee Deduction successfully edited.'
        success_message = self.driver.find_element_by_xpath("//*[@aria-label = 'Employee Deduction successfully edited.']")
        actual_text = success_message.text

        expected_text == actual_text

    def test_regular_dedecution_delete_button_under_table_record(self):
        """Check "Create" button functionality under "Record Table".""" 
        ...
        delete_icon = self.driver.find_element(By.XPATH ,"//*[@id='page-top']/div[1]/div/div/div/div[2]/div/div[2]/table/tbody/tr[2]/td/div[8]/button[1]")
        delete_icon.click()
        ...
        success_message = self.driver.find_element_by_xpath("//*[@aria-label = 'Employee Deduction successfully deleted.']")
        actual_text = success_message.text
