...
from utils import searchbox, filter_effectivity, right_click, pagination, prompt, auto_approval_review, record_per_page, record_field, auto_approval, toast_container, filters
...
from utils.apply import recommender_apply as apply
class Setup():
    ...
    def setup_method(self, method):
        ...
        leave_application = self.driver.find_element(By.XPATH, '//*[@id="leave_approval"]/a')
...
class TestDate(Setup):
    ...
    def test_specific_date_in_the_calendar(self):
        ...
        input_date_from_xpath = "/html/body/div[2]/div/div[3]/div/div/div/div[1]/form/div[1]/tabletoolsdaterange2/p" \
                                "/div[1]/ul/li[1]/div/div/div/table/tbody/tr[1]/td[1]/button"

        date_from_calendar_clicked = date.leave_date_from(self)
        ...
        input_date_to_xpath = "/html/body/div[2]/div/div[3]/div/div/div/div[1]/form/div[1]/tabletoolsdaterange2/p/" \
                              "div[2]/ul/li[1]/div/div/div/table/tbody/tr[5]/td[3]/button"

        date_to_calendar_clicked = date.leave_date_to(self)
...
class TestAdvancefilter(Setup):
    ...
    def test_dropdown_arrow_icon(self):
        ...
        dropdown_icon_button = self.driver.find_element(By.XPATH,
                                                        "//*[@id='page-wrapper']/div[3]/div/div/div/div[1]/form/div[2]/tabletoolstrans/div/div/div/button[3]")
        dropdown_icon_button.click()
        sleep(3)
        dropdown_options = self.driver.find_element(By.XPATH,
                                                    "//*[@id='page-wrapper']/div[3]/div/div/div/div[1]/form/div[2]/tabletoolstrans/div/div/div/ul")
        options_displayed = dropdown_options.is_displayed()
...
class TestEffectivityDate(Setup):
    ...
    def test_filter_by_effectivity_date_functionality(self):
        ...
        filter_checkbox = self.driver.find_element(By.XPATH,
                                                   "/html/body/div[2]/div/div[3]/div/div/div/div[1]/form/div[4]/label/div/ins")
...
class TestApply(Setup):
    ...
    def test_auto_approval_recommend_specific_employee(self):
        """Check response when applying auto approval to a reviewed request"""
        ...
        sleep(2)
        input_filter = "Reviewed"
        input_pending =  self.driver.find_element(By.XPATH, "//*[@id='page-wrapper']/div[3]/div/div/div/div[1]/form/div[2]/"
                                                            "tabletoolstrans/div/div/div/div/div[2]/div/div/div/span[1]/div[1]/"
                                                            "div/ul/li/input")
        input_pending.send_keys(input_filter)
        input_pending.send_keys(Keys.ENTER)
        sleep(2)
        apply_search = self.driver.find_element(By.XPATH, "//*[@id='page-wrapper']/div[3]/div/div/div/div[1]/form/div[2]/"
                                                          "tabletoolstrans/div/div/div/div/div[2]/div/div/div/span[1]/div[11]/button[1]")
        apply_search.click()
        sleep(5)
        ...
        apply_button = self.driver.find_element(By.XPATH,
                                                "//*[@id='page-wrapper']/div[3]/div/div/div/div[1]/form/button[1]")
        apply_button.click()
        sleep(3)
        confirmation_dialog = self.driver.find_element(By.XPATH, "//*[@id='page-top']/div[4]")
        confirmation = confirmation_dialog.is_displayed()
    ...
    def test_auto_approval_recommend_multiple_employees(self):
...
class TestAutoApproval(Setup):
    ...
    @pytest.mark.skip(reason="passed")
    def test_auto_approval_recommend_dropdown_functionality(self):
        """Check response when clicking "Recommend" dropdown"""

        expected_text = "Recommend"
        option_displayed = auto_approval_review.dropdown(self)
        review_option = self.driver.find_element(By.XPATH,
                                                 "/html/body/div[2]/div/div[3]/div/div/div/div[1]/form/div[6]/div/div/ul/li/ul/li/div/div")
        review_option.click()
        sleep(3)
        auto_approval_dropdown = self.driver.find_element(By.XPATH,
                                                          "//*[@id='page-wrapper']/div[3]/div/div/div/div[1]/form/div[6]/div/a/span[2]/span")
    ...
    def test_auto_approval_recommend_button_option(self):
        """Check response when clicking "Recommend" button"""
        ...
        try:
            review_option = self.driver.find_element(By.XPATH,
                                                     "/html/body/div[2]/div/div[3]/div/div/div/div[1]/form/div[6]/div/div/ul/li/ul/li/div/div")
            review_option.click()
            click_review_button = True
        except Exception:
            click_review_button = False
        sleep(5)
        assert option_displayed == True
        assert click_review_button == True
        self.driver.close()

class TestLeaveAnalysis(Setup):
    ...
    def test_leave_analysis_with_valid_data_in_date_field(self):
        ...
        actual_date_from = date.date_from_input_box(self, date_from_input)

        date_to_input = "05/31/2022"
        actual_date_to = date.date_to_input_box(self, date_to_input)
...
class TestRecordsPerPage(Setup):
    ...
    def test_record_per_page_dropdown(self):
        ...
        option_1 = self.driver.find_element(By.XPATH,
                                            "/html/body/div[2]/div/div[3]/div/div/div/div[1]/form/div[7]/div/ul/li/div[3]/a/div").is_displayed()
        option_2 = self.driver.find_element(By.XPATH,
                                            "/html/body/div[2]/div/div[3]/div/div/div/div[1]/form/div[7]/div/ul/li/div[5]/a/div").is_displayed()
        option_3 = self.driver.find_element(By.XPATH,
                                            "/html/body/div[2]/div/div[3]/div/div/div/div[1]/form/div[7]/div/ul/li/div[6]/a/div").is_displayed()
    ...
    def test_select_number_in_record_per_page_dropdown(self):
        ...
        records_per_page_dropdown = self.driver.find_element(By.XPATH,
                                                             "//*[@id='page-wrapper']/div[3]/div/div/div/div[1]/form/div[7]/div/div/span/span[2]/span")
...
class TestRecordsField(Setup):
    ...
    def test_response_when_clicking_record_checkbox(self):
        ...
        advance_filter_option = self.driver.find_element(By.XPATH, "//*[@popover-title ='Advance Filter']")
        advance_filter_option.click()
        sleep(3)
        deselect_all = self.driver.find_element(By.XPATH,
                                                "//*[@id='page-wrapper']/div[3]/div/div/div/div[1]/form/div[2]/"
                                                "tabletoolstrans/div/div/div/div/div[2]/div/div/div/span[1]/div[1]/button[2]")
        deselect_all.click()
        sleep(2)
        input_filter = "Pending"
        input_pending = self.driver.find_element(By.XPATH,
                                                 "//*[@id='page-wrapper']/div[3]/div/div/div/div[1]/form/div[2]/"
                                                 "tabletoolstrans/div/div/div/div/div[2]/div/div/div/span[1]/div[1]/"
                                                 "div/ul/li/input")
        input_pending.send_keys(input_filter)
        input_pending.send_keys(Keys.ENTER)
        sleep(2)
        apply_search = self.driver.find_element(By.XPATH,
                                                "//*[@id='page-wrapper']/div[3]/div/div/div/div[1]/form/div[2]/"
                                                "tabletoolstrans/div/div/div/div/div[2]/div/div/div/span[1]/div[11]/button[1]")
        apply_search.click()
        sleep(5)
    ...
    def test_response_when_clicking_leave_approval_dialog_reviewed(self):
        """ Check response when clicking "Leave Approval dialog" button """
    ...
    def test_response_when_clicking_pages(self):
        ...
        options = self.driver.find_element(By.XPATH,
                                           "//*[@id='page-wrapper']/div[3]/div/div/div/div[1]/form/div[7]/div/ul")
