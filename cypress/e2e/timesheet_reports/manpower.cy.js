...
describe('login', () => {
    ...
    describe('navigate to complete timesheet', () => {
        it('should search calendar', () => {
            ...
            // searchbar
            cy.get('.select2-search-field > .select2-input').type('MAIN {enter}');
            ...
            // view by
            cy.get(':nth-child(3) > .ui-select-container > .select2-choice > .select2-arrow > b').click();
            ...
            //period
            cy.get('[select="change_tab(\'period\')"] > .nav-link').click();
            cy.get('[ng-model="filters.date_from"]').clear().type('12/10/2023');
            cy.get('tabletoolsdaterange2 > .input-group > .form-control.ng-pristine').clear().type('12/26/2023');
            cy.get('.input-group > .hand_cursor').click();
            cy.get('.input-group > .ui-select-container > .select2-choice > .select2-arrow > b').click();
            cy.get(':nth-child(2) > .select2-result-label > .ng-binding').click();
            cy.get('div.pull-right > [type="button"]').click();
