describe('Special Reports - SSS Monthly Remittances Report', () => {
    beforeEach(() => {
        cy.viewport(1280, 900);
        cy.login();
    });

    it('should navigate to SSS Monthly Remittances, select payroll period, and generate report', () => {
        cy.navigateMenu([
            '#dmpi_reports_list > [href="#"]',
            '#monthlies_list > a',
            '#sss_monthly_remittances > a'
        ]);
