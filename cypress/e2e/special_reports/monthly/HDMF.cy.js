describe('Special Reports - Monthly HDMF Remittances Report', () => {
    beforeEach(() => {
        cy.viewport(1280, 900);
        cy.login();
    });

    it('should navigate to HDMF Monthly Remittances, select payroll period, and generate report', () => {
        cy.navigateMenu([
            '#dmpi_reports_list > [href="#"]',
            '#monthlies_list > a',
            '#hdmf_monthly_remittances > a'
        ]);
