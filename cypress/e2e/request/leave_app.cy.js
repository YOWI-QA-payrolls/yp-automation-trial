    ...
    describe('Leave Application Workflow', () => {
        it('should navigate to leave request, filter by date, and create a new leave application', () => {
            ...
            cy.get('body').then(($body) => {
                ...
                cy.get('tabletoolsdaterange2 > .input-group > .form-control.ng-pristine').clear();
                cy.get('tabletoolsdaterange2 > .input-group > .form-control').last().type('12/21/2024');
                ...
                cy.select2First('.pull-left > .ui-select-container > .select2-choice > .select2-arrow > b');
                cy.get('tbody', { timeout: 30000 }).should('exist');
