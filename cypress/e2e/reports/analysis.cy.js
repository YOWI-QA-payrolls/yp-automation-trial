describe('login', () => {
    ...
    describe('navigate to employee', () => {
        it('should go to dashboard', () => {
            ...
            cy.get('.select2-highlighted > .select2-result-label > .ng-binding').click();
            cy.get(':nth-child(6) > .form-group > .ui-select-container > .select2-choice > .select2-chosen.ng-binding').click();
            cy.get(':nth-child(4) > .select2-result-label').click();
            cy.get(':nth-child(7) > .form-group > .ui-select-container > .select2-choice > .select2-chosen.ng-binding').click();
