describe('login', () => {
    ...
    describe('navigate to complete timesheet', () => {
        it('should search calendar', function() { this.skip();
            ...
            cy.get('#employee_salary > a').click();
            ...
            cy.get(':nth-child(1) > td > .col-sm-4.form-group > .ui-select-container > .select2-choice > .select2-chosen.ng-binding').click();
            ...
            .contains('29')
            .click();
            // cy.get('[ng-show="salary_list.rate_status.rate_status.val == \'monthly\'"] > .fa').click();
        });
    });
