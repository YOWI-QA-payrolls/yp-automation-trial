describe('login', () => {
    ...
    describe('navigate to complete timesheet', () => {
        it.skip('should search calendar', () => {
            ...
            cy.get('#employee_activity > a').click();
            ...
            cy.get(':nth-child(1) > td > :nth-child(1) > .ui-select-container > .select2-choice > .select2-chosen.ng-binding').click();
            cy.get('.select2-result-label > .ng-binding').click();
            cy.get('.input-group-btn > .btn').click();
            cy.get('.btn-info').click();
            // cy.get('.col-sm-2 > .btn > .fa').click();
