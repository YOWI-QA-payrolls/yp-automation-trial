describe('Employee Employment Type', () => {
    beforeEach(() => {
        cy.viewport(1280, 900);
        cy.login();
    });

    it('should navigate to employment type and interact with form', () => {
        cy.navigateMenu([
            '#employee_list > a',
            '#information_list > a',
            '#employee_employment_type > a',
        ]);
        ...
        cy.get('tbody > :nth-child(4) > :nth-child(2)', { timeout: 15000 }).click();
