describe('login', () => {
    ...
    describe('navigate to complete timesheet', () => {
        it.skip('should search calendar', () => {
            ...
            // create
            // cy.get('tbody > [style=""] > :nth-child(2)').click();
            // cy.get(':nth-child(2) > .ui-select-container > .select2-choice > [ng-hide="$select.isEmpty()"]').click();
            ...
            cy.get('.col-sm-3.pull-left > .ui-select-container > .select2-choice > .select2-chosen.ng-binding').click();
            cy.get(':nth-child(3) > .select2-result-label > .ng-binding').click();
            cy.get(':nth-child(2) > .ui-select-container > .select2-choice > .select2-chosen.ng-binding').click();
