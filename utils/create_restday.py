...
class CreateRestday():
    ...
    def input_hour(self, hour):
        input_hour = self.driver.find_element(By.XPATH, "//*[@ng-model = 'restday.hours']")
    ...
    def input_minute(self, minute):
        input_minute = self.driver.find_element(By.XPATH,"//*[@ng-model = 'restday.minutes']")
    ...
    def input_reason(self, reason):
        input_reason = self.driver.find_element(By.XPATH,"//*[@ng-model = 'restday.reason']")
    ...
    def input_remarks(self, remarks):
        input_reason = self.driver.find_element(By.XPATH,"//*[@ng-model = 'restday.remarks']")
