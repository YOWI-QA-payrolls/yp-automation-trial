...
class CreateOvertime():
    ...
    def input_hour(self, hour):
        input_hour = self.driver.find_element(By.XPATH,"//*[@id='page-top']/div[1]/div/div/div/div[2]/div/div[2]/form/div[7]/div[1]/input")
    ...
    def input_minute(self, minute):
        input_minute = self.driver.find_element(By.XPATH,"//*[@ng-model = 'overtime.minutes']")
    ...
    def input_reason(self, reason):
        input_reason = self.driver.find_element(By.XPATH,"//*[@ng-model = 'overtime.reason']")
    ...
    def input_remarks(self, remarks):
        input_reason = self.driver.find_element(By.XPATH,"//*[@ng-model = 'overtime.remarks']")
    ...
    def click_confirm_button(self):
        confirm_button = self.driver.find_element(By.XPATH,"//*[@id='page-top']/div[6]/div[7]/button[2]")
    ...
    def click_select_all(self):
        select_all = self.driver.find_element(By.XPATH,"//*[@id='page-top']/div[1]/div/div/div/div[2]/div/div[2]/form/div[4]/button[1]")
        select_all.click()
