...
class CreateHoliday():
    ...
    def input_hour(self, hour):
        ...
        input_hour = self.driver.find_element(By.XPATH, "//*[@ng-model = 'holiday.hours']")
    ...
    def input_minute(self, minute):
        """input holiday minute"""

        input_minute = self.driver.find_element(By.XPATH,"//*[@ng-model = 'holiday.minutes']")
    ...
    def input_reason(self, reason):
        """input holiday reason"""

        input_reason = self.driver.find_element(By.XPATH,"//*[@ng-model = 'holiday.reason']")
